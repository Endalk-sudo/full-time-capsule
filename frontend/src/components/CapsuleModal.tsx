...
import { gerPreSignedUrls, uploadFiles } from "@/services/s3.service";
...
const formSchema = z.object({
  ...
  message: z
    .string()
    .min(15, "Message has to be at least 15 characters")
    .max(500, "Message MAX character is 500"),
      ...
      >
        ...
        <section className="flex flex-col gap-4">
          ...
          <div>
            ...
            <Input
              id="title"
              placeholder="eg,. Birthday Photo"
              {...register("title")}
            />
            {errors.title && (
              <span className="pt-2 text-xs font-medium text-red-500">
            ...
            <div>
              <div className="my-4 flex gap-2">
                <Input
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(), handleAddRecipient())
                  }
                />
                <Button
                  type="button"
